        ...
        <nav className="bg-white  fixed w-full z-20 top-0 left-0 border-b">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://digibillz.com" className="flex items-center">
              <img src="https://digibillz.com/media/Image/digibillzlogo_jiGeyvI.png" className="h-8 mr-3" alt="Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Digibillz</span>
            </a>
